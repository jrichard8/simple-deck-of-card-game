...
public class PlayerResourceIntTest {
    ...
    private static final Integer DEFAULT_SUM_OF_CARD_VALUE = 1;
    private static final Integer UPDATED_SUM_OF_CARD_VALUE = 2;
    ...
    public static Player createEntity(EntityManager em) {
        Player player = new Player()
            .name(DEFAULT_NAME)
            .sumOfCardValue(DEFAULT_SUM_OF_CARD_VALUE);
        return player;
    }
    ...
    public void createPlayer() throws Exception {
        ...
        assertThat(testPlayer.getSumOfCardValue()).isEqualTo(DEFAULT_SUM_OF_CARD_VALUE);
    }
    ...
    public void getAllPlayers() throws Exception {
        ...
        restPlayerMockMvc.perform(get("/api/players?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].sumOfCardValue").value(hasItem(DEFAULT_SUM_OF_CARD_VALUE)));
    }
    ...
    public void getPlayer() throws Exception {
        ...
        restPlayerMockMvc.perform(get("/api/players/{id}", player.getId()))
            ...
            .andExpect(jsonPath("$.sumOfCardValue").value(DEFAULT_SUM_OF_CARD_VALUE));
    }
    ...
    public void updatePlayer() throws Exception {
        ...
        updatedPlayer
            .name(UPDATED_NAME)
            .sumOfCardValue(UPDATED_SUM_OF_CARD_VALUE);
        ...
        assertThat(testPlayer.getSumOfCardValue()).isEqualTo(UPDATED_SUM_OF_CARD_VALUE);
    }
